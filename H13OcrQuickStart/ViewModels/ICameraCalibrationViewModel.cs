...
namespace H13OcrQuickStart.ViewModels
{
     ...
     public interface ICameraCalibrationViewModel
     {
          ...
          HTuple FocalLengthParameters { get; set; }
          ...
          HTuple ImageHeightParameters { get; set; }
          ...
          HTuple ImageWidthParameters { get; set; }
          ...
          HTuple RotationParameters { get; set; }
          ...
          /// <summary>
          /// Gets or sets the sensor size x parameters.
          /// </summary>
          /// <value>The sensor size x parameters.</value>
          HTuple SensorSizeXParameters { get; set; }
          ...
          /// <summary>
          /// Gets or sets the sensor size y parameters.
          /// </summary>
          /// <value>The sensor size y parameters.</value>
          HTuple SensorSizeYParameters { get; set; }
          ...
          HTuple TransXParameters { get; set; }
          ...
          HTuple TransYParameters { get; set; }
          ...
          HTuple TransZParameters { get; set; }
